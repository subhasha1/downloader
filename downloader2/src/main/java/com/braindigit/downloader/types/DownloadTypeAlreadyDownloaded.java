...
public class DownloadTypeAlreadyDownloaded extends DownloadType {

    public DownloadTypeAlreadyDownloaded(FileInfo fileInfo, DownloadManager downloadManager, DownloadListener downloadListener) {
