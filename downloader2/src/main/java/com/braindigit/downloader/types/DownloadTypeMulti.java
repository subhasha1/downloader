...
public class DownloadTypeMulti extends DownloadTypeContinue {

    public DownloadTypeMulti(FileInfo fileInfo, DownloadManager downloadManager, DownloadListener downloadListener) {
